...
gulp.task('FontAwesome', () => {
    return gulp.src(['node_modules/font-awesome/css/font-awesome.min.css', 'node_modules/font-awesome/fonts/*'], { base: 'node_modules/font-awesome/', allow_empty: true })
        .pipe(debug({title: 'copy:'}))
        .pipe(gulp.dest(`${__dirname}/dist/`));
});

gulp.task('js_dependencies', () => {
    return gulp.src(['node_modules/bootstrap/dist/js/bootstrap.min.js', 'node_modules/jquery/dist/jquery.min.js', 'node_modules/popper.js/dist/umd/popper.min.js'], { allow_empty: true })
        .pipe(debug({ title: 'copy:' }))
